      ...
      <div class="max-w-2xl mx-auto">
        <form ref="contactForm" @submit.prevent="submitForm" class="space-y-4 opacity-0">
          ...
          <div ref="submitButton" class="opacity-0">
            <button 
              type="submit" 
              class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary dark:ring-offset-gray-800"
