        ...
        <div class="w-full lg:w-3/5 overflow-hidden" ref="contentSection">
          ...
          <div class="mt-8 flex flex-wrap gap-4 animation-element" ref="ctaRef">
            <a
              ...
              class="px-8 py-3 bg-primary hover:bg-primary/70 dark:hover:bg-primary/70 text-gray-700 dark:text-white rounded-xl font-semibold transition-all duration-300 hover:text-gray-900 dark:hover:text-gray-300 hover:shadow-lg hover:-translate-y-1 flex items-center gap-2">
