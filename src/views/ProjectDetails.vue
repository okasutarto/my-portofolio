  ...
  <div class="project-details min-h-screen">
    ...
    <div v-else>
      ...
      <section class="relative pt-20 pb-32 overflow-hidden">
        ...
        <div class="container max-w-6xl mx-auto px-4 relative z-10">
          ...
          <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span
                class="inline-block px-3 py-1 text-sm font-semibold rounded-full bg-primary/10 text-primary mb-4">
                {{ project.type }}
              </span>
              <h1
            ...
            <div class="relative">
              ...
              <!-- Decorative elements -->
              <div
                class="absolute -bottom-4 -right-4 w-full h-full bg-primary/20 rounded-2xl -z-10"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section
        ...
        class="py-16 bg-gray-900 dark:bg-white text-white dark:text-gray-700">
        <div class="container max-w-4xl mx-auto px-4 text-center">
          ...
          <div class="grid grid-cols-3 gap-8">
            <div
              ...
              <p class="text-white/80 dark:text-gray-700">{{ metric.label }}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container max-w-4xl mx-auto px-4">
          ...
          <div class="grid sm:grid-cols-2 gap-4">
            <div
              ...
              <div
                class="w-8 h-8 rounded-full bg-secondary/10 flex items-center justify-center flex-shrink-0">
        ...
        <div class="container max-w-4xl mx-auto px-4 text-center">
          ...
          <div class="flex flex-wrap justify-center gap-4">
            <router-link
              ...
              class="px-6 py-3 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 text-gray-700 dark:text-gray-300 font-medium">
              {{ otherProject.title }}
            </router-link>
          </div>
          <router-link
            to="/#projects"
            class="inline-block mt-8 text-primary hover:text-primary-dark font-medium">
            ← View All Projects
          </router-link>
        </div>
      </section>
