...
export const projects = [
  {
    ...
    // Case Study Details
    overview: 'Summarizer is a powerful AI application that leverages OpenAI\'s GPT models to transform lengthy documents, images, and text into concise, meaningful summaries. Built with Next.js and modern UI components, it provides an intuitive interface for users to quickly extract key information from various content types.',
    
    problem: {
      title: 'The Challenge',
      description: 'In today\'s information-rich world, professionals spend hours reading through lengthy documents, articles, and reports. There was a need for a tool that could quickly distill essential information without losing context or key details.',
      points: [
    ...
    solution: {
      title: 'The Solution',
      description: 'I developed Summarizer as an all-in-one AI summarization tool that handles multiple content formats. Using OpenAI\'s powerful language models, it can understand context, identify key themes, and generate accurate summaries in seconds.',
      points: [
    ...
    technologies: ['Next.js', 'React', 'Shadcn UI', 'OpenAI API', 'Tailwind CSS', 'TypeScript'],
    ...
    screenshots: [
      { url: 'https://picsum.photos/800/450?random=1', caption: 'Main dashboard interface' },
      { url: 'https://picsum.photos/800/450?random=2', caption: 'PDF summarization view' },
      { url: 'https://picsum.photos/800/450?random=3', caption: 'Results with copy feature' }
    ],
    ...
    // SEO
    metaDescription: 'AI-powered summarization tool built with Next.js and OpenAI API'
  },
  {
    id: 'pokedex',
    title: 'Pokedex',
    ...
    problem: {
      title: 'The Challenge',
      description: 'Pokémon fans needed a fast, visually appealing way to browse and discover Pokémon information without the clutter of traditional wikis.',
      points: [
    ...
    solution: {
      title: 'The Solution',
      description: 'I created a modern, responsive Pokedex application that focuses on speed, usability, and visual appeal. The app fetches data from PokéAPI and presents it in an engaging card-based format.',
      points: [
    ...
    technologies: ['Vue.js', 'Pinia', 'Bootstrap', 'SASS', 'Axios', 'PokéAPI', 'Vite'],
    ...
    screenshots: [
      { url: 'https://picsum.photos/800/450?random=4', caption: 'Pokémon grid view' },
      { url: 'https://picsum.photos/800/450?random=5', caption: 'Detailed Pokémon stats' },
      { url: 'https://picsum.photos/800/450?random=6', caption: 'Search and filter interface' }
    ],
    ...
    metaDescription: 'Interactive Pokémon encyclopedia built with Vue.js and PokéAPI'
  },
  {
    id: 'portfolio',
    ...
    problem: {
      title: 'The Challenge',
      description: 'Traditional portfolios are static and require visitors to manually search through content to find relevant information about a developer.',
      points: [
    ...
    solution: {
      title: 'The Solution',
      description: 'I integrated an AI chatbot that uses my resume and project data to provide instant, accurate responses to visitor questions. This creates a unique, interactive experience.',
      points: [
    ...
    technologies: ['Vue.js', 'OpenAI API', 'Tailwind CSS', 'GSAP', 'Node.js', 'Vercel'],
    ...
    screenshots: [
      { url: 'https://picsum.photos/800/450?random=11', caption: 'Hero section with animations' },
      { url: 'https://picsum.photos/800/450?random=12', caption: 'AI Chatbot in action' },
      { url: 'https://picsum.photos/800/450?random=13', caption: 'Projects showcase' }
    ],
    ...
    metaDescription: 'AI-enhanced portfolio with chatbot built with Vue.js and OpenAI'
  },
  {
    id: 'warung-upin',
    ...
    problem: {
      title: 'The Challenge',
      description: 'Small retail shops needed an affordable yet powerful POS system with proper inventory tracking and user management.',
      points: [
    ...
    solution: {
      title: 'The Solution',
      description: 'I built a robust backend API that handles all POS operations with secure authentication, comprehensive stock management, and detailed transaction logging.',
      points: [
    ...
    technologies: ['Node.js', 'Express', 'PostgreSQL', 'Sequelize ORM', 'JWT', 'REST API'],
    ...
    screenshots: [
      { url: 'https://picsum.photos/800/450?random=8', caption: 'API documentation' },
      { url: 'https://picsum.photos/800/450?random=9', caption: 'Database schema' }
    ],
