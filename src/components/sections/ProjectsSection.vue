<template>
  <section id="projects" class="relative py-8 md:py-12 overflow-hidden">
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div
        class="h-1 w-20 bg-primary mx-auto rounded-full mb-16 opacity-0"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div
          ...
          <div
            class="project-card group bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-500 ease-out transform hover:-translate-y-2 hover:shadow-2xl h-full">
            ...
            <div class="p-5">
              ...
              <p
                :ref="
                  (el) => {
                    if (el) projectDescriptions[index] = el;
                  }
                "
              ...
              <div
                :ref="
                  (el) => {
                    if (el) projectTechStacks[index] = el;
                  }
                "
                ...
                <div class="flex flex-wrap gap-2">
                  <span
                    ...
                    :key="techIndex"
                    class="tech-badge bg-gray-100 hover:text-primary dark:hover:text-primary dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-xs px-2 py-1 rounded-md">
                    {{ tech }}
                  </span>
                  <span
      ...
      animations.push(
        gsap.fromTo(
          ...
          { opacity: 0, x: -20 },
          {
            ...
            x: 0,
            duration: 0.5,
            delay: 0.3 + index * 0.15, // Appears after title (0.2)
            ease: "power2.out",
            scrollTrigger: {
